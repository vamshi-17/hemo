    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (this.hospitalDetails == null) {
                ...
                this.mHospital.setText(this.hospitalDetails.getmHosCode());
            }
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(this, "Something went wrong", 0).show();
        }
        this.mGender.setOnClickListener(new View.OnClickListener() { // from class: edu.communication.hemo.hospital.AddDoctorActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                AddDoctorActivity.this.mPickerUI.setVisibility(0);
        ...
        this.mSpecialization.setOnClickListener(new View.OnClickListener() { // from class: edu.communication.hemo.hospital.AddDoctorActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                AddDoctorActivity.this.mSpecialitiesPickerUi.setVisibility(0);
        ...
        this.mPickerUI.setOnClickItemPickerUIListener(new PickerUI.PickerUIItemClickListener() { // from class: edu.communication.hemo.hospital.AddDoctorActivity.3
            @Override // com.dpizarro.uipicker.library.picker.PickerUI.PickerUIItemClickListener
            public void onItemClickPickerUI(int which, int position, String valueResult) {
                Toast.makeText(AddDoctorActivity.this, valueResult, 0).show();
                AddDoctorActivity.this.mGender.setText(valueResult);
                AddDoctorActivity.this.mGender.setError(null);
            }
        });
        this.mSpecialitiesPickerUi.setOnClickItemPickerUIListener(new PickerUI.PickerUIItemClickListener() { // from class: edu.communication.hemo.hospital.AddDoctorActivity.4
            @Override // com.dpizarro.uipicker.library.picker.PickerUI.PickerUIItemClickListener
            public void onItemClickPickerUI(int which, int position, String valueResult) {
                Toast.makeText(AddDoctorActivity.this, valueResult, 0).show();
    ...
    class AnonymousClass5 implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (AddDoctorActivity.this.validateFields()) {
                ...
                doctorDetails.setmHospital(AddDoctorActivity.this.hospitalDetails.getmHosCode());
                ...
                try {
                    ...
                    AddDoctorActivity.this.myRef.child(CommonData.DOCTORS).child(encodedEmail).addListenerForSingleValueEvent(new ValueEventListener() { // from class: edu.communication.hemo.hospital.AddDoctorActivity.5.1
                        @Override // com.google.firebase.database.ValueEventListener
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                AddDoctorActivity.this.myRef.child(CommonData.DOCTORS).child(encodedEmail).setValue(doctorDetails).addOnCompleteListener(new OnCompleteListener<Void>() { // from class: edu.communication.hemo.hospital.AddDoctorActivity.5.1.1
                                    ...
                                    public void onComplete(Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Utils.showSuccessDialogue(addDoctorActivity2, "Doctor " + AddDoctorActivity.this.mName.getText().toString() + " is added successfully", true);
                                        }
                                    }
                                });
                            } else {
                                AddDoctorActivity.this.myRef.child(CommonData.DOCTORS).child(encodedEmail).setValue(doctorDetails).addOnCompleteListener(new OnCompleteListener<Void>() { // from class: edu.communication.hemo.hospital.AddDoctorActivity.5.1.2
                                    @Override // com.google.android.gms.tasks.OnCompleteListener
                                    public void onComplete(Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            AddDoctorActivity.this.awesomeProgressDialog.dismiss();
                        ...
                        public void onCancelled(DatabaseError databaseError) {
                            AddDoctorActivity.this.awesomeProgressDialog.dismiss();
                            Toast.makeText(AddDoctorActivity.this, "Something went wrong. Please try again..!!", 0).show();
                        }
                    });
                } catch (Exception e) {
                    e.printStackTrace();
                    AddDoctorActivity.this.awesomeProgressDialog.dismiss();
                    Toast.makeText(AddDoctorActivity.this, "Unable to process request. Please try again..!!", 0).show();
                }
            }
        }
    }
