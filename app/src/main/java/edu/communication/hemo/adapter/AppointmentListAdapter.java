...
public class AppointmentListAdapter extends RecyclerView.Adapter<AppointmentListAdapter.MyViewHolder> {
    ...
    public AppointmentListAdapter(Context context, ArrayList<AppointmentDetails> appointmentDetailsArrayList, DoctorDetails doctorDetails, MyInterface listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.mobile.setOnClickListener(new View.OnClickListener() { // from class: edu.communication.hemo.adapter.AppointmentListAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Dexter.withActivity((Activity) AppointmentListAdapter.this.context).withPermission("android.permission.CALL_PHONE").withListener(new PermissionListener() { // from class: edu.communication.hemo.adapter.AppointmentListAdapter.1.1
        ...
        holder.btReject.setOnClickListener(new View.OnClickListener() { // from class: edu.communication.hemo.adapter.AppointmentListAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AppointmentListAdapter.this.listener.rejectAppointment(appointmentDetails.getuId());
            }
        });
        holder.btAccept.setOnClickListener(new View.OnClickListener() { // from class: edu.communication.hemo.adapter.AppointmentListAdapter.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AppointmentListAdapter.this.listener.acceptAppointment(appointmentDetails);
            }
        });
    }
